...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun getPolylines(): ArrayList<LatLng> {
        ...
        val data =
            requestLocationData("maps.googleapis.com/maps/api/directions/json?origin=-23.684214090444453,-46.61648161543652&destination=-23.566246583252205,-46.59241262112984&sensor=false&mode=driving&key=AIzaSyDnfZ5OSLAIcc9Pim5JEWc4C2q8pRqeDv8")
